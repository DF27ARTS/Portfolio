...
export const Weather_App_Descriptions = {
  ...
  description1_english: "It has a Favorites section and detail",

  description3_spanish: "Creada con el proposito de mejorar mis habilidades con React y TypeScript",
  description1_english: "Created with the purpose of improving my skills with React and TypeScript"
}
